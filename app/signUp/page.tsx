...
export default function SignUp() {
  ...
  return (
    <>
    <div className="flex-1 xl:pt-[5.5rem]">
<div className="flex max-w-lg mx-auto my-16 overflow-hidden bg-white rounded-lg lg:space-x-8 dark:bg-[#2A1A17] lg:max-w-5xl">
  <div className="items-center hidden lg:flex lg:w-1/2">
    <img
      src="https://www.creative-tim.com/twcomponents/svg/queue-animate.svg"
      alt="queue-animate.svg"
    />
  </div>{" "}
  <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
    ...
    <p className="mt-2 text-xl text-center text-gray-600 dark:text-gray-200">
      Join <span className="text-primary">Our Creative</span>{" "}
      community
    </p>{" "}
    ...
    <form onSubmit={handleSignUp}>
      ...
      placeholder="Enter your name"
        type="hidden"
        name="_token"
        defaultValue="dldlvQxVfRrygN8OJbMJ0UNPr6wLscgfJY5UENLE"
        autoComplete="off"
      />{" "}
      <div className="mt-4">
